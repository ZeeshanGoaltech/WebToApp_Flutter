...
/// Download APK / AAB paywall — same design as [LifetimePremiumView],
/// purchases the credits pack in-app product.
class DownloadInappView extends GetView<DownloadInappController> {
  const DownloadInappView({super.key});
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: Obx(
                              () => Text(
                                controller.isAab.value
                                    ? 'download_inapp_hero_aab'.tr
                                    : 'download_inapp_hero_apk'.tr,
                              ...
                              children: [
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'download_inapp_access_title'.tr,
                                        style: const TextStyle(
                                          fontSize: 17,
                                      ...
                                      Text(
                                        'download_inapp_access_subtitle'.tr,
                                        style: const TextStyle(
                                          fontSize: 12,
                  ...
                  () {
                    ...
                    return Positioned(
                      ...
                      child: IapCloseButton(
                        onTap: () => controller.finish(purchased: false),
                      ),
                    );
                  },
                ),
      ...
      children: [
        Container(
          ...
          decoration: const BoxDecoration(
            color: DownloadInappView.iconBg,
          ...
          child: SvgPicture.asset(
            ...
            placeholderBuilder: (_) => Icon(
              fallbackIcon,
              color: DownloadInappView.primary,
              size: 14,
            ),
          ),
        ),
        ...
        Expanded(
          child: Text(
            ...
            style: const TextStyle(
              fontSize: 14,
              fontWeight: FontWeight.w600,
              color: DownloadInappView.heading,
            ),
          ),
        ),
        SvgPicture.asset(
  ...
  Widget build(BuildContext context) {
    return TextButton(
      ...
      child: Text(
        ...
        textAlign: TextAlign.center,
        style: const TextStyle(
          color: DownloadInappView.footer,
          fontSize: 12,
          fontWeight: FontWeight.w500,
        ),
      ),
