...
/**
 * Medium horizontal native ad — icon left, text + small CTA bottom-right.
 * Factory ID: "mediumAd"
 * Layout: custom_medium_native_ad.xml
 */
class VerticalMediumNativeAdFactory(private val context: Context) : NativeAdFactory {
    override fun createNativeAd(
        nativeAd: NativeAd,
        customOptions: Map<String, Any>?
    ): NativeAdView {
        android.util.Log.d(TAG, "=== Factory called: verticalMediumAd ===")
        ...
        val adView = try {
            val inflated = layoutInflater.inflate(
                com.webtoapp.converter.appmaker.R.layout.custom_medium_native_ad,
                null
            ) as NativeAdView
        ...
        try {
            ...
            val mediaView = adView.findViewById<MediaView>(com.webtoapp.converter.appmaker.R.id.ad_media)
            if (mediaView != null) {
            ...
            val headlineView = adView.findViewById<TextView>(com.webtoapp.converter.appmaker.R.id.ad_headline)
            ...
            val bodyView = adView.findViewById<TextView>(com.webtoapp.converter.appmaker.R.id.ad_body)
            if (bodyView != null) {
            ...
            val callToActionView = adView.findViewById<TextView>(com.webtoapp.converter.appmaker.R.id.ad_call_to_action)
            ...
            // Text colors are handled by XML theme attributes (?attr/nativeAdTextPrimary)
    ...
    companion object {
        private const val TAG = "VerticalMediumNativeAdFactory"
    }
}
